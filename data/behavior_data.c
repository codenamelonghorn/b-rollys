...
const BehaviorScript bhvWfSolidTowerPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(wf_seg7_collision_trapezoid),//LOAD_COLLISION_DATA(wf_seg7_collision_platform),
    BEGIN_LOOP(),
...
const BehaviorScript bhvMario[] = {
    ...
    BEGIN_LOOP(),
	    CALL_NATIVE(check_debug_button_seq),
	    CALL_NATIVE(try_change_debug_page),
		CALL_NATIVE(try_modify_debug_controls),
...
const BehaviorScript bhvFocusPlaceholder[] = {
    BEGIN(OBJ_LIST_DEFAULT),
};
