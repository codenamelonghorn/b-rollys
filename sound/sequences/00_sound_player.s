...
.layer_3A6:
layer_note1 25, 0xc, 80
layer_note1 33, 0x18, 80
layer_end
...
chan_setbank 3
chan_setinstr 0
chan_setlayer 0, .layer_96F
chan_end

.layer_96E:
layer_somethingon
.layer_96F:
layer_note1 37, 0x12c, 80
...
.layer_988:
layer_note1 38, 0x8, 105
#layer_somethingon
.layer_98C:
layer_note1 37, 0x12c, 70
...
sound_ref .sound_mario_secondjump
sound_ref .sound_mario_spinjump
sound_ref .sound_mario_fall
sound_ref .sound_mario_lift
sound_ref .sound_mario_throw
sound_ref .sound_mario_hang
sound_ref .sound_mario_climb
sound_ref .sound_mario_damage
sound_ref .sound_mario_tumble
sound_ref .sound_mario_yeeah
sound_ref .sound_mario_jump_hoo
sound_ref .sound_mario_jump_hoo
sound_ref .sound_mario_jump_hoo
sound_ref .sound_mario_jump_hoo
...
layer_transpose 254
.layer_C5C:
#layer_portamento 0x81, 40, 255
layer_note1 40, 0x32, 127
layer_end

.sound_mario_secondjump:
chan_setbank 8
chan_setinstr 3
...
.layer_CDC:
layer_transpose 254
layer_portamento 0x85, 40, 255
layer_note1 41, 0xb8, 127
layer_end
...
.layer_10D2:
layer_note1 38, 0x18, 85
layer_setinstr 2
layer_note1 39, 0x50, 80
layer_end
...
chan_setval 25
chan_call .set_reverb
chan_setlayer 0, .layer_11E4_beta
chan_end
...
chan_setlayer 1, .layer_11E4_beta
chan_setval 1
chan_call .delay
chan_setbank 4
chan_setinstr 6
...
#chan_setval 25
#chan_call .set_reverb
#chan_setlayer 0, .layer_11E4_beta #.layer_1242
...
.layer_1344:
layer_portamento 0x81, 45, 115
layer_note1 48, 0x7f, 115
layer_end
...
.layer_1350:
layer_note0 30, 0xd, 115, 20
layer_note0 29, 0xe, 115, 20
layer_note0 28, 0xd, 115, 20
layer_note0 27, 0xa, 115, 20
layer_note0 26, 0x7, 115, 20
layer_note0 25, 0x60, 115, 20
layer_end
...
.layer_204E:
#layer_note1 33, 0x18, 127
layer_note1 29, 0x5c, 127
layer_end
...
.layer_20F4:
layer_note1 38, 0x10, 120
layer_note1 33, 0x3c, 120
layer_end
...
#chan_setlayer 0, .layer_11E4_beta
#chan_setlayer 1, .layer_2E3D_beta
#chan_setlayer 2, .layer_2E34_beta
##chan_setval 70
##chan_call .delay
##chan_setbank 10
##chan_setinstr 8
