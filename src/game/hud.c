...
void render_power_meter_health_segment(s16 numHealthWedges) {
	...
	g_Tani_LoadTextureImage2(gDisplayListHead++,(*healthLUT)[(numHealthWedges*2)], G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 64, 0, 7);
	gSP1Triangle(gDisplayListHead++, 0, 1, 2, 0);
    gSP1Triangle(gDisplayListHead++, 0, 2, 3, 0);
	gDPPipeSync(gDisplayListHead++);
	g_Tani_LoadTextureImage2(gDisplayListHead++,(*healthLUT)[(numHealthWedges*2)+1], G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 64, 0, 7);
...
void render_hud_mario_lives(void) {
	#if LUIGI != 2
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(/*22*/30), HUD_TOP_Y, ","); // 'Mario Head' glyph
	#else 
	print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(/*22*/30), HUD_TOP_Y, "="); // 'Luigi Head' glyph
	#endif
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(/*38*/50-3), HUD_TOP_Y, "*"); // 'X' glyph
	#if DEMO
        print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(/*50*/62-3), HUD_TOP_Y,  "%d", gHudDisplay.lives);
	#else
	    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(/*50*/62-3), HUD_TOP_Y, "%2d", gHudDisplay.lives);
	#endif
}
...
void render_hud_coins(void) {
	...
	#if DEMO
        print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X) + 28, HUD_TOP_Y-17,  "%d", gHudDisplay.coins);
	#else
		print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X) + 28, HUD_TOP_Y-17, "%2d", gHudDisplay.coins);
	#endif
}
...
void render_hud_stars(void) {
	...
	#if DEMO
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X) + 28,
...
/*#ifndef VERSION_EU
    ...
    print_text(/*22*/170, 20, "TIME");
    print_text_fmt_int(/*81*/229, /*169*/20, "%0d", timerMins);
    print_text_fmt_int(/*101*/249, /*169*/20, "%02d", timerSecs);
    print_text_fmt_int(/*135*/283, /*169*/20, "%d", timerFracSecs);
    gSPDisplayList(gDisplayListHead++, dl_hud_img_begin);
    gSPDisplayList(gDisplayListHead++, dl_hud_img_end);
}
