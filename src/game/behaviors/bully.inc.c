...
void bully_backup_check(s16 collisionFlags) {
    if (!(collisionFlags & 0x8) && o->oAction != BULLY_ACT_KNOCKBACK) /* bit 3 */
    {
        ...
        o->oPosY = o->oBullyPrevY; //! Commented out behavior in gigaleak 
...
void bhv_big_bully_with_minions_init(void) {
    big_bully_spawn_minion(3954, 307, -2426, 0);
    big_bully_spawn_minion(3440, 307, -1841, 0);
    big_bully_spawn_minion(3026, 307, -2226, 0);
    ...
    switch (o->oAction) {
        ...
        case BULLY_ACT_INACTIVE:
            ...
            if (o->oBullyKBTimerAndMinionKOCounter == 3) {
				...
				if (o->oTimer >= 91) {
					o->oTimer = 0;
					spawn_default_star(3546, 607, -2021);
