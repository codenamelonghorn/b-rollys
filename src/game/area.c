...
#ifdef VERSION_EU
            print_text_centered(SCREEN_WIDTH, /*20*/30, gNoControllerMsg[language]);
#else
            print_text_centered(SCREEN_WIDTH, /*20*/30, "NO CONTROLLER");
#endif
        } else {
#ifdef VERSION_EU
            print_text(20, /*20*/32, "START");
#else
            print_text_centered(60, /*38*/48, "PRESS");
            print_text_centered(60, /*20*/30, "START");
#endif
        }
    }
}
...
void render_game(void) {
	...
	//! Why was the hud renderer moved here?
	//render_hud();
