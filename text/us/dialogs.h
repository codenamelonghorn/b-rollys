...
DEFINE_DIALOG(DIALOG_000, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_001, 1, 4, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_002, 1, 4, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_003, 1, 5, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_004, 1, 3, 95, 182, _("\
We're peace-loving\n\
...
DEFINE_DIALOG(DIALOG_005, 1, 3, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_006, 1, 3, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_007, 1, 5, 30, 182, _("\
Hufff...fff...pufff...\n\
Whoa! You...really...are...\n\
fast! A human blur!\n\
...
DEFINE_DIALOG(DIALOG_008, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_009, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_010, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_011, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_012, 1, 4, 30, 182, _("\
You've just stepped on\n\
...
DEFINE_DIALOG(DIALOG_013, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_014, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_015, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_016, 1, 3, 30, 182, _("\
Hop on the shiny shell and\n\
ride wherever you want to\n\
go! Shred those enemies!"))

DEFINE_DIALOG(DIALOG_017, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_018, 1, 4, 30, 182, _("\
I'm sleeping because...\n\
...I'm sleepy. I don't\n\
like being disturbed.\n\
Please walk quietly."))

DEFINE_DIALOG(DIALOG_019, 1, 2, 30, 182, _("\
Shhh! Please walk\n\
...
DEFINE_DIALOG(DIALOG_021, 1, 5, 95, 182, _("\
Welcome.\n\
No one's home!\n\
Now " SCRAM "\n\
and don't come back!\n\
...
DEFINE_DIALOG(DIALOG_022, 1, 2, 95, 182, _("\
You need a key to open\n\
this door."))

DEFINE_DIALOG(DIALOG_023, 1, 3, 95, 182, _("\
This key doesn't fit!\n\
Maybe it's for the\n\
basement..."))

DEFINE_DIALOG(DIALOG_024, 1, 5, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_025, 1, 4, 95, 182, _("\
It takes the power of\n\
3 Stars to open this\n\
door. You need [%] more\n\
Stars."))

DEFINE_DIALOG(DIALOG_026, 1, 4, 95, 182, _("\
It takes the power of\n\
8 Stars to open this\n\
door. You need [%] more\n\
Stars."))

DEFINE_DIALOG(DIALOG_027, 1, 4, 95, 182, _("\
It takes the power of\n\
30 Stars to open this\n\
door. You need [%] more\n\
Stars."))

DEFINE_DIALOG(DIALOG_028, 1, 4, 95, 182, _("\
It takes the power of\n\
50 Stars to open this\n\
door. You need [%] more\n\
Stars."))

DEFINE_DIALOG(DIALOG_029, 1, 5, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_030, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_031, 1, 5, 30, 182, _("\
No way! You beat me...\n\
...
DEFINE_DIALOG(DIALOG_032, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_033, 1, 6, 30, 182, _("\
Ciao! You've reached\n\
...
DEFINE_DIALOG(DIALOG_034, 1, 6, 30, 182, _("\
Good afternoon. The\n\
Lakitu Bros., here,\n\
...
DEFINE_DIALOG(DIALOG_035, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_036, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_037, 1, 2, 30, 182, _("\
I win! You lose!\n\
Ha ha ha ha!\n\
...
DEFINE_DIALOG(DIALOG_038, 1, 3, 95, 182, _("\
Reacting to the Star\n\
power, the door slowly\n\
opens."))

DEFINE_DIALOG(DIALOG_039, 1, 4, 30, 182, _("\
No visitors allowed,\n\
by decree of\n\
the Big Bob-omb\n\
\n\
...
DEFINE_DIALOG(DIALOG_040, 1, 3, 30, 182, _("\
Warning!\n\
Cold, Cold Crevasse\n\
Below!"))

DEFINE_DIALOG(DIALOG_041, 1, 3, 30, 182, _("\
I win! You lose!\n\
Ha ha ha!\n\
\n\
...
DEFINE_DIALOG(DIALOG_042, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_043, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_044, 1, 5, 95, 182, _("\
Whooo's there? Whooo\n\
...
DEFINE_DIALOG(DIALOG_045, 1, 6, 95, 182, _("\
Whew! I'm just about\n\
...
DEFINE_DIALOG(DIALOG_046, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_047, 1, 2, 95, 182, _("\
Hi! I'll prepare the\n\
cannon for you!"))

DEFINE_DIALOG(DIALOG_048, 1, 4, 30, 182, _("\
Snow Mountain Summit\n\
Watch for slippery\n\
conditions! Please enter\n\
the cottage first."))

DEFINE_DIALOG(DIALOG_049, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_050, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_051, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_052, 1, 5, 30, 182, _("\
Stop and press [Z] to\n\
crouch, then press [A]\n\
...
DEFINE_DIALOG(DIALOG_053, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_054, 1, 5, 30, 182, _("\
Welcome to the snow\n\
...
DEFINE_DIALOG(DIALOG_055, 1, 4, 30, 182, _("\
Hey-ey, Mario, buddy,\n\
...
DEFINE_DIALOG(DIALOG_056, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_057, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_058, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_059, 1, 4, 30, 182, _("\
That's not my baby! She\n\
looks nothing like me!\n\
Her parents must be\n\
worried sick!"))

DEFINE_DIALOG(DIALOG_060, 1, 4, 30, 182, _("\
ATTENTION!\n\
...
DEFINE_DIALOG(DIALOG_061, 1, 4, 30, 182, _("\
BRRR! Frostbite Danger!\n\
Do not swim here.\n\
I'm serious.\n\
/--The Penguin"))

DEFINE_DIALOG(DIALOG_062, 1, 3, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_063, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_064, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_065, 1, 6, 30, 182, _("\
Swimming Lessons!\n\
...
DEFINE_DIALOG(DIALOG_066, 1, 5, 30, 182, _("\
Mario, it's Peach!\n\
...
DEFINE_DIALOG(DIALOG_067, 1, 5, 30, 182, _("\
Tough luck, Mario!\n\
...
DEFINE_DIALOG(DIALOG_068, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_069, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_070, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_071, 1, 3, 30, 182, _("\
Danger Ahead!\n\
...
DEFINE_DIALOG(DIALOG_072, 1, 5, 30, 182, _("\
High winds ahead!\n\
...
DEFINE_DIALOG(DIALOG_073, 1, 4, 95, 182, _("\
Aarrgh! Ahoy, matey. I\n\
...
DEFINE_DIALOG(DIALOG_074, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_075, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_076, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_077, 1, 2, 150, 182, _("\
It is decreed that one\n\
shall pound the pillars."))

DEFINE_DIALOG(DIALOG_078, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_079, 1, 4, 30, 182, _("\
Owwwuu! Let me go!\n\
...
DEFINE_DIALOG(DIALOG_080, 1, 1, 30, 182, _("\
Eeeh hee hee hee!"))

DEFINE_DIALOG(DIALOG_081, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_082, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_083, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_084, 1, 3, 30, 182, _("\
Yeeoww! Unhand me,\n\
...
DEFINE_DIALOG(DIALOG_085, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_086, 1, 3, 30, 182, _("\
Running around in circles\n\
makes some bad guys roll\n\
their eyes."))

DEFINE_DIALOG(DIALOG_087, 1, 4, 30, 182, _("\
Santa Claus isn't the only\n\
one who can go down a\n\
chimney! Come on in!\n\
/--Cabin Proprietor"))

DEFINE_DIALOG(DIALOG_088, 1, 5, 30, 182, _("\
Work Elevator\n\
...
DEFINE_DIALOG(DIALOG_089, 1, 5, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_090, 1, 6, 30, 182, _("\
Bwa ha ha ha!\n\
...
DEFINE_DIALOG(DIALOG_091, 2, 2, 30, 182, _("\
Danger!\n\
Strong Gusts!\n\
But the wind makes a\n\
comfy ride."))

DEFINE_DIALOG(DIALOG_092, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_093, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_094, 1, 4, 30, 182, _("\
Get a good run up the\n\
slope! Do you remember\n\
the Long Jump? Run, press\n\
[Z], then jump!"))

DEFINE_DIALOG(DIALOG_095, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_096, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_097, 1, 5, 30, 182, _("\
Don't be a pushover!\n\
...
DEFINE_DIALOG(DIALOG_098, 1, 2, 95, 182, _("\
Come on in here...\n\
...heh, heh, heh..."))

// unused
DEFINE_DIALOG(DIALOG_099, 1, 5, 95, 182, _("\
Eh he he...\n\
...
DEFINE_DIALOG(DIALOG_100, 1, 3, 95, 182, _("\
Ukkiki...Wakkiki...kee kee!\n\
Ha! I snagged it!\n\
It's mine! Heeheeheeee!"))

DEFINE_DIALOG(DIALOG_101, 1, 3, 95, 182, _("\
Ackk! Let...go...\n\
You're...choking...me...\n\
...
DEFINE_DIALOG(DIALOG_102, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_103, 1, 4, 95, 182, _("\
Upon four towers\n\
one must alight...\n\
Then at the peak\n\
shall shine the light..."))

DEFINE_DIALOG(DIALOG_104, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_105, 1, 3, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_106, 1, 2, 95, 182, _("\
Ready for blastoff! Come\n\
on, hop into the cannon!"))

DEFINE_DIALOG(DIALOG_107, 1, 3, 95, 182, _("\
Ghosts...\n\
...don't...\n\
...DIE!\n\
Heh, heh, heh!\n\
...
DEFINE_DIALOG(DIALOG_108, 1, 2, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_109, 1, 4, 95, 182, _("\
Ooooo Nooooo!\n\
...
DEFINE_DIALOG(DIALOG_110, 1, 5, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_111, 1, 4, 95, 182, _("\
Perfect! What a great\n\
new body! Here--this is a\n\
present for you. It's sure\n\
to warm you up."))

DEFINE_DIALOG(DIALOG_112, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_113, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_114, 1, 5, 95, 182, _("\
...
DEFINE_DIALOG(DIALOG_115, 1, 5, 95, 182, _("\
No! Crushed again!\n\
...
DEFINE_DIALOG(DIALOG_116, 1, 5, 95, 182, _("\
Whaaa....Whaaat?\n\
Can it be that a\n\
...
DEFINE_DIALOG(DIALOG_117, 1, 1, 95, 182, _("\
Who...walk...here?\n\
Who...break...seal?\n\
Wake..ancient..ones?\n\
We no like light...\n\
...
DEFINE_DIALOG(DIALOG_118, 1, 6, 95, 182, _("\
Grrrrumbbble!\n\
What...happen?\n\
...
DEFINE_DIALOG(DIALOG_119, 1, 6, 30, 182, _("\
Grrr! I was a bit\n\
...
DEFINE_DIALOG(DIALOG_120, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_121, 1, 5, 30, 182, _("\
Nooo! It can't be!\n\
...
DEFINE_DIALOG(DIALOG_122, 1, 4, 30, 182, _("\
The Black Hole\n\
Right: Work Elevator\n\
/// Cloudy Maze\n\
Left: Underground Lake"))

DEFINE_DIALOG(DIALOG_123, 1, 4, 30, 182, _("\
Metal Cavern\n\
Right: To Waterfall\n\
Left: Metal Cap Switch"))

DEFINE_DIALOG(DIALOG_124, 1, 4, 30, 182, _("\
Work Elevator\n\
Danger!!\n\
Read instructions\n\
thoroughly!\n\
...
DEFINE_DIALOG(DIALOG_125, 1, 3, 30, 182, _("\
Hazy Maze-Exit\n\
Danger! Closed.\n\
Turn back now."))

DEFINE_DIALOG(DIALOG_126, 2, 3, 30, 182, _("\
Up: Black Hole\n\
Right: Work Elevator\n\
/// Hazy Maze"))

DEFINE_DIALOG(DIALOG_127, 3, 4, 30, 182, _("\
Underground Lake\n\
Right: Metal Cave\n\
Left: Abandoned Mine\n\
///(Closed)\n\
...
DEFINE_DIALOG(DIALOG_128, 1, 4, 95, 182, _("\
You must fight with\n\
honor! It is against the\n\
royal rules to throw the\n\
king out of the ring!"))

DEFINE_DIALOG(DIALOG_129, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_130, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_131, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_132, 1, 4, 30, 182, _("\
Whoa, Mario, pal, you\n\
...
DEFINE_DIALOG(DIALOG_133, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_134, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_135, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_136, 1, 6, 30, 182, _("\
Wow! You've already\n\
recovered that many\n\
...
DEFINE_DIALOG(DIALOG_137, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_138, 1, 3, 30, 182, _("\
Down: Underground Lake\n\
Left: Black Hole\n\
Right: Hazy Maze (Closed)"))

DEFINE_DIALOG(DIALOG_139, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_140, 1, 6, 30, 182, _("\
Elevator Area\n\
Right: Hazy Maze\n\
/// Entrance\n\
Left: Black Hole\n\
...
DEFINE_DIALOG(DIALOG_141, 1, 5, 150, 182, _("\
...
DEFINE_DIALOG(DIALOG_142, 1, 5, 150, 182, _("\
...
DEFINE_DIALOG(DIALOG_143, 1, 6, 150, 182, _("\
...
DEFINE_DIALOG(DIALOG_144, 1, 6, 150, 182, _("\
You've recovered 30\n\
Power Stars! Now you can\n\
...
DEFINE_DIALOG(DIALOG_145, 1, 6, 150, 182, _("\
You've recovered 50\n\
Power Stars! Now you can\n\
...
DEFINE_DIALOG(DIALOG_146, 1, 6, 150, 182, _("\
...
DEFINE_DIALOG(DIALOG_147, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_148, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_149, 1, 3, 30, 182, _("\
Welcome to\n\
Princess Toadstool's\n\
secret slide!\n\
...
DEFINE_DIALOG(DIALOG_150, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_151, 1, 4, 30, 182, _("\
I can't take this\n\
...
DEFINE_DIALOG(DIALOG_152, 1, 3, 30, 182, _("\
Owwch! Uncle! Uncle!\n\
...
DEFINE_DIALOG(DIALOG_153, 1, 4, 30, 182, _("\
Hey! Who's there?\n\
...
DEFINE_DIALOG(DIALOG_154, 1, 5, 30, 182, _("\
Hold on to your hat! If\n\
you lose it, you'll be\n\
...
DEFINE_DIALOG(DIALOG_155, 1, 6, 30, 182, _("\
Thanks to the power of\n\
the Stars, life is\n\
returning to the castle.\n\
Please, Mario, you have\n\
...
DEFINE_DIALOG(DIALOG_156, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_157, 1, 5, 30, 182, _("\
Watch out! Don't let\n\
...
DEFINE_DIALOG(DIALOG_158, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_159, 1, 6, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_160, 1, 4, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_161, 1, 4, 30, 182, _("\
Mario!!!\n\
It that really you???\n\
...
DEFINE_DIALOG(DIALOG_162, 1, 4, 30, 182, _("\
No, no, no! Not you\n\
...
DEFINE_DIALOG(DIALOG_163, 1, 5, 30, 182, _("\
Noooo! You've really\n\
beaten me this time,\n\
Mario! I can't stand\n\
losing to you!\n\
...
DEFINE_DIALOG(DIALOG_164, 1, 4, 30, 182, _("\
Mario! What's up, pal?\n\
...
DEFINE_DIALOG(DIALOG_165, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_166, 1, 4, 30, 182, _("\
I'll be back soon.\n\
I'm out training now,\n\
so come back later.\n\
//--Koopa the Quick"))

DEFINE_DIALOG(DIALOG_167, 1, 4, 30, 182, _("\
Princess Toadstool's\n\
...
DEFINE_DIALOG(DIALOG_168, 1, 5, 30, 182, _("\
...
DEFINE_DIALOG(DIALOG_169, 1, 4, 30, 182, _("\
Keep out!\n\
That means you!\n\
Arrgghh!\n\
\n\
