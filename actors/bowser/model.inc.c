...
#include "actors/bowser/bowser_eye_blue_half_closed_0.rgba16.inc.c"
};
...
#include "actors/bowser/bowser_eye_blue_half_closed_1.rgba16.inc.c"
};
...
#define SCALE 0.25
#define ShapeColor_kopa(R,G,B) gdSPDefLights1(R*SCALE, G*SCALE, B*SCALE, R, G, B, LIGHT_X, LIGHT_Y, LIGHT_Z)

static Lights1 light_kopa[] = {
	ShapeColor_kopa(255,255,255),
	ShapeColor_kopa(206,199,  0),
	ShapeColor_kopa(210,210,  0),
};
...
const Gfx bowser_seg6_dl_06039110[] = {
    ...
    gsSPLight((&light_kopa[0].l[0]),1 ),
	gsSPLight((&light_kopa[0].a   ),2 ),
...
const Gfx bowser_seg6_dl_0603FFA8[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
	gsSPLight((&light_kopa[1].l[0]),1 ),
	gsSPLight((&light_kopa[1].a   ),2 ),
