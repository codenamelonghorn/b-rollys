...
UNUSED static const u64 binid_13 = 12;//13;

UNUSED static const u64 binid_14 = 13;//14;

#include "mushroom_1up/model.inc.c"
UNUSED static const u64 binid_15 = 14;//15;

#include "star/model.inc.c"
UNUSED static const u64 binid_16 = 15;//16;

#include "sand/model.inc.c"
UNUSED static const u64 binid_17 = 16;//17;

#include "dirt/model.inc.c"
UNUSED static const u64 binid_18 = 17;//18;

#include "transparent_star/model.inc.c"
UNUSED static const u64 binid_19 = 18;//19;

#include "white_particle/model.inc.c"
UNUSED static const u64 binid_20 = 19;//20;

#include "wooden_signpost/model.inc.c"
#include "wooden_signpost/collision.inc.c"
UNUSED static const u64 binid_21 = 20;//21;

#include "tree/model.inc.c"
UNUSED static const u64 binid_22 = 21;//22;

#include "dotstar/dotstar.sou"
UNUSED static const u64 binid_23 = 22;//23;
