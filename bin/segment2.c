...
#include "textures/segment2/hud_glyph_x.rgba16.inc.c"
};

ALIGNED8 static const u8 texture_hud_char_coin[] = {
#include "textures/segment2/hud_glyph_coin.rgba16.inc.c"
};

ALIGNED8 static const u8 texture_hud_char_mario_head[] = {
#include "textures/segment2/hud_glyph_mario.rgba16.inc.c"
};

ALIGNED8 static const u8 texture_hud_char_luigi_head[] = {
#include "textures/segment2/hud_glyph_luigi.rgba16.inc.c"
};

ALIGNED8 static const u8 texture_hud_char_star[] = {
#include "textures/segment2/hud_glyph_star.rgba16.inc.c"
};

#if (defined(VERSION_JP) || defined(VERSION_SH)) && !(ENGLISH == 1)
ALIGNED8 static const u8 texture_hud_char_decimal_point[] = {
#include "textures/segment2/hud_glyph_coin_shadow.rgba16.inc.c"
};
#endif

#if (defined(VERSION_JP) || defined(VERSION_SH)) && !(ENGLISH == 1)
ALIGNED8 static const u8 texture_hud_char_beta_key[] = {
#include "textures/segment2/hud_glyph_key.rgba16.inc.c"
};
#endif
...
const u8 *const main_hud_lut[] = {
    ...
    texture_hud_char_W,               0x0, texture_hud_char_Y, texture_hud_char_Z,
                  ...
                  0x0,               0x0,               0x0,               0x0,
                  0x0,               0x0,               0x0,               0x0,
                  0x0, texture_hud_char_luigi_head, texture_hud_char_multiply, texture_hud_char_coin,
    texture_hud_char_mario_head, texture_hud_char_star, 0x0,               0x0,
    0x0, 0x0, texture_hud_char_umlaut,
...
const u8 *const main_font_lut[] = {
    ...
    0x0, 0x0,
#elif defined(VERSION_US) || (ENGLISH == 1) // US Font Table
...
#elif (defined(VERSION_JP) || defined(VERSION_SH)) && !(ENGLISH == 1)
