...
#define ACT_OSHIN_WAIT                 (0x00C | ACT_FLAG_STATIONARY | ACT_FLAG_ALLOW_FIRST_PERSON | ACT_FLAG_PAUSE_EXIT)
...
#define hmsJoint(layer, displayList, x, y, z) \
...
#define hmsScale(scale) \
    CMD_BBH(0x1D, 0x00, 0x0000), \
    CMD_W(scale),
#define hmsGfxScale(layer, displayList, scale) \
    CMD_BBH(0x1D, (layer | 0x80), 0x0000), \
    CMD_W(scale), \
    CMD_PTR(displayList),
#define hmsShadow(scale, solidity, type) \
