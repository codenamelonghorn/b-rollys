...
#define SOUND_MARIO_YAH_WAH_HOO                         SOUND_ARG_LOAD(2, 4, 0x00, 0x80, 8)
					    ...
					    */
#define SOUND_MARIO_SECONDJUMP                          SOUND_ARG_LOAD(2, 4, 0x03, 0x80, 8) /* Step! */
#define SOUND_MARIO_SPINJUMP                            SOUND_ARG_LOAD(2, 4, 0x04, 0x80, 8) /* Jump! */
#define SOUND_MARIO_SPECIALJUMP                         SOUND_ARG_LOAD(2, 4, 0x04, 0x80, 8) /* Jump! */
#define SOUND_MARIO_FALL                                SOUND_ARG_LOAD(2, 4, 0x05, 0x80, 8) /* Fall from above to bottom */
#define SOUND_MARIO_LIFT                                SOUND_ARG_LOAD(2, 4, 0x06, 0x80, 8) /* Lift up an object */
#define SOUND_MARIO_THROW                               SOUND_ARG_LOAD(2, 4, 0x07, 0x80, 8) /* Throw an object */
#define SOUND_MARIO_HANG                                SOUND_ARG_LOAD(2, 4, 0x08, 0xC0, 8) /* Hook hands above player */ 
#define SOUND_MARIO_CLIMB                               SOUND_ARG_LOAD(2, 4, 0x09, 0x80, 8) /* Climbing */
#define SOUND_MARIO_DAMAGE                              SOUND_ARG_LOAD(2, 4, 0x0A, 0xFF, 8) /* Damaged */ 
#define SOUND_MARIO_TUMBLE                              SOUND_ARG_LOAD(2, 4, 0x0B, 0xD0, 8) /* Fall on bottom */   
#define SOUND_MARIO_CAUGHT                              SOUND_ARG_LOAD(2, 4, 0x0B, 0x80, 8) /* Fall on bottom */   
#define SOUND_MARIO_NO                                  SOUND_ARG_LOAD(2, 4, 0x0B, 0x80, 8) /* Tubusare */
#define SOUND_MARIO_YEEAH                               SOUND_ARG_LOAD(2, 4, 0x0C, 0x80, 8) /* Get Coin  */  
#define SOUND_MARIO_JOY                                 SOUND_ARG_LOAD(2, 4, 0x0C, 0x80, 8) /* Get Coin  */  
...
//! Why isn't SOUND_MENU_REVERSE_PAUSE defined properly?
#define SOUND_MENU_PAUSE_THE                                SOUND_ARG_LOAD(7, 0, 0x01, 0x00, 8)
