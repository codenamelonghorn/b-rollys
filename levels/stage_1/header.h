#ifndef STAGE1_HEADER_H
#define STAGE1_HEADER_H
...
//extern const struct MovtexQuadCollection stage_1_movtex_water[];
extern short castle_info[];

// script
extern const LevelScript level_stage_1_entry[];
