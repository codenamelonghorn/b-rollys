...
DEFINE_COURSE(COURSE_CASTLE, 0x00002040) // (ID 1)  Castle
DEFINE_COURSE(COURSE_TESTATH, 0x00002040) // (ID 2)  Test Athletic
DEFINE_COURSE(COURSE_DONJON, 0x00002040) // (ID 3)  Donjon
DEFINE_COURSE(COURSE_TESTMAP, 0x00002040) // (ID 32)  Testmap
DEFINE_COURSES_END()
DEFINE_BONUS_COURSE(COURSE_DUMMY, 0x44444440) // Levels marked as "DUMMY"
