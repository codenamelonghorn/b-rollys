...
static const LevelScript script_func_local_5[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE, /*pos*/ 1340, -4001,  2311, /*angle*/ 0, 0, 0, /*behParam*/ 0x03000000, /*beh*/ bhvJetStreamRingSpawner, /*acts*/ ALL_ACTS),
...
const LevelScript level_ddd_entry[] = {
    ...
    AREA(/*index*/ 2, ddd_geo_000570),
		...
		// The objects make Mario vanish. Figure out why.
