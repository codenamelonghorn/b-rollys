...
Movtex lll_movtex_tris_lava_floor[] = {
    ...
    MOV_TEX_TRIS(    0, 0,  8192, 0, 12),
    MOV_TEX_TRIS(-8191, 0,  8192, 0, 24),
    MOV_TEX_TRIS( 8191, 0,     0, 12, 0),
    MOV_TEX_TRIS(    0, 0,     0, 12, 12),
    MOV_TEX_TRIS(-8191, 0,     0, 12, 24),
    MOV_TEX_TRIS( 8191, 0, -8192, 24, 0),
    MOV_TEX_TRIS(    0, 0, -8192, 24, 12),
    MOV_TEX_TRIS(-8191, 0, -8192, 24, 24),
};
