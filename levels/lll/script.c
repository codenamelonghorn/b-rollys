...
//    OBJECT(/*model*/ MODEL_LLL_SINKING_RECTANGULAR_PLATFORM,   /*pos*/  2816,    0,   512, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvLllSinkingRectangularPlatform),
    OBJECT(/*model*/ MODEL_LLL_SINKING_RECTANGULAR_PLATFORM,   /*pos*/ -1791,    0, -3595, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvLllSinkingRectangularPlatform),
...
//    OBJECT(/*model*/ MODEL_LLL_ROLLING_LOG,                    /*pos*/  6144,  307,  6016, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvLllRollingLog),
    OBJECT(/*model*/ MODEL_LLL_ROTATING_BLOCK_FIRE_BARS,       /*pos*/ -2019,  307, -1895, /*angle*/ 0,  0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvLllRotatingBlockWithFireBars),
    OBJECT(/*model*/ MODEL_LLL_ROTATING_HEXAGONAL_PLATFORM,    /*pos*/ -2019,    0, -1895, /*angle*/ 0,  0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvLllRotatingHexagonalPlatform),
    OBJECT(/*model*/ MODEL_NONE,                               /*pos*/ -2883,    0,  1872, /*angle*/ 0, 90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvLllFloatingWoodBridge),
    RETURN(),
};

static const LevelScript script_func_local_4[] = {
    OBJECT(/*model*/ MODEL_NONE,            /*pos*/ -3179,  307,  3456, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMrI),
	OBJECT(/*model*/ MODEL_STAR,			/*pos*/	    0, 0500, -6200, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStar),
	OBJECT(/*model*/ MODEL_NONE,			/*pos*/		0,  165, -5200, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/bhvLllTumblingBridge),
    //OBJECT(/*model*/ MODEL_BULLY_BOSS,      /*pos*/     0,  307, -4385, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBigBully),
    OBJECT(/*model*/ MODEL_BULLY_BOSS,      /*pos*/  3546, 2234, -2021, /*angle*/ 0,   0, 0, /*behParam*/ 0x01000000, /*beh*/ bhvBigBullyWithMinions), // "bully the bullies"
    OBJECT(/*model*/ MODEL_BULLY,           /*pos*/ -2883,  307,  -195, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallBully), // bully from duo 1
    OBJECT(/*model*/ MODEL_BULLY,           /*pos*/     0,  307,  3712, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallBully), // starting bully
    //OBJECT(/*model*/ MODEL_BULLY,           /*pos*/  6813,  307,  1613, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallBully), // don't use
    OBJECT(/*model*/ MODEL_BULLY,           /*pos*/  -23,  318, -3832, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallBully), // don't use
    OBJECT(/*model*/ MODEL_BULLY,           /*pos*/ -2583,  285,   695, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallBully), // bully from duo 1
...
const LevelScript level_lll_entry[] = {
    ...
    AREA(/*index*/ 1, lll_area_1),//lll_geo_000E00),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/  1480, 1154, 6272, /*angle*/ 0,  -90, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvSpinAirborneWarp),
        ...
        TERRAIN(/*terrainData*/ lll_area_1_collision),//lll_seg7_area_1_collision),
    ...
    FREE_LEVEL_POOL(),
    MARIO_POS(/*area*/ 1, /*yaw*/ 90, /*pos*/ 1480, 154, 6272),
