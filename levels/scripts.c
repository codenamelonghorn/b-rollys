...
extern const GeoLayout RCP_MarioHierarchy[];
extern const GeoLayout RCP_LuigiHierarchy[];
extern const GeoLayout RCP_TitleMario[];
...
const LevelScript level_main_scripts_entry[] = {
	...
	#elif LUIGI == 1
	LOAD_MODEL_FROM_GEO(MODEL_MARIO,                   RCP_MarioHierarchy),
	LOAD_MODEL_FROM_GEO(MODEL_LUIGI,                   RCP_LuigiHierarchy),
	#else
	LOAD_MODEL_FROM_GEO(MODEL_MARIO,                   RCP_LuigiHierarchy),
    #endif
    ...
    LOAD_MODEL_FROM_GEO(MODEL_COLLECTED_STAR,          RCP_HmsDotstar),
	LOAD_MODEL_FROM_GEO(MODEL_ITEM_STAR_DUST,          RCP_HmsItemStarDust),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_YELLOW_COIN_NO_SHADOW,   yellow_coin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLUE_COIN,               yellow_coin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLUE_COIN_NO_SHADOW,     yellow_coin_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_RED_COIN,                yellow_coin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_RED_COIN_NO_SHADOW,      yellow_coin_geo),
