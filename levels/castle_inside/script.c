...
static const LevelScript script_func_local_1[] = {
    ...
    PAINTING_WARP_NODE(/*id*/ 0x00, /*destLevel*/ LEVEL_CCM, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x01, /*destLevel*/ LEVEL_CCM, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x02, /*destLevel*/ LEVEL_CCM, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x03, /*destLevel*/ LEVEL_WF, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x04, /*destLevel*/ LEVEL_WF, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x05, /*destLevel*/ LEVEL_WF, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x06, /*destLevel*/ LEVEL_LLL, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x07, /*destLevel*/ LEVEL_LLL, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    PAINTING_WARP_NODE(/*id*/ 0x08, /*destLevel*/ LEVEL_LLL, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1516,  429, -4497, /*angle*/ 0,    0, 0, /*behParam*/ 0x300B0000, /*beh*/ bhvWarp),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1516,  600, -4497, /*angle*/ 0,  180, 0, /*behParam*/ 0x00240000, /*beh*/ bhvLaunchStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1516,  600, -4497, /*angle*/ 0,  180, 0, /*behParam*/ 0x00250000, /*beh*/ bhvLaunchDeathWarp),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -5146, 640,   596, /*angle*/ 0, 270, 0, /*behParam*/ 0x00320000, /*beh*/ bhvPaintingStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -2571, 128, -2162, /*angle*/ 0, 180, 0, /*behParam*/ 0x00330000, /*beh*/ bhvPaintingStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -454, 128, -2162, /*angle*/ 0, 180, 0, /*behParam*/ 0x00340000, /*beh*/ bhvPaintingStarCollectWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2121, 640,   596, /*angle*/ 0,  90, 0, /*behParam*/ 0x00350000, /*beh*/ bhvPaintingStarCollectWarp),
    ...
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -5146, 640,   596, /*angle*/ 0, 270, 0, /*behParam*/ 0x00640000, /*beh*/ bhvPaintingDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/ -2571, 128, -2162, /*angle*/ 0, 180, 0, /*behParam*/ 0x00650000, /*beh*/ bhvPaintingDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  -454, 128, -2162, /*angle*/ 0, 180, 0, /*behParam*/ 0x00660000, /*beh*/ bhvPaintingDeathWarp),
    OBJECT(/*model*/ MODEL_NONE, /*pos*/  2121, 640,   596, /*angle*/ 0,  90, 0, /*behParam*/ 0x00670000, /*beh*/ bhvPaintingDeathWarp),
...
static const LevelScript script_func_local_3[] = {
    OBJECT(/*model*/ MODEL_CASTLE_CASTLE_DOOR, /*pos*/ -1100, -1074, 922, /*angle*/ 0,   0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvDoorWarp),
    OBJECT(/*model*/ MODEL_CASTLE_CASTLE_DOOR, /*pos*/  -946, -1074, 922, /*angle*/ 0, 180, 0, /*behParam*/ 0x00010000, /*beh*/ bhvDoorWarp),
...
const LevelScript level_castle_inside_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR_3_STARS,       RCP_HmsMainroomDoorA), // 3
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR_1_STAR,        RCP_HmsMainroomDoorB), // 1
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR_2_STARS,       RCP_HmsMainroomDoorC), // 2
	LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR_4_STARS,       RCP_HmsMainroomDoorD), // 4
    ...
    AREA(/*index*/ 1, castle_inside_area_1),
        OBJECT(/*model*/ MODEL_NONE,       /*pos*/ -1516,  634, -4497, /*angle*/ 0,   0, 0, /*behParam*/ 0x00140000, /*beh*/ bhvCastleFloorTrap),
        ...
        TERRAIN(/*terrainData*/ castle_inside_area_1_collision),
    ...
    FREE_LEVEL_POOL(),
    MARIO_POS(/*area*/ 1, 180,  -1503,0,1152),
