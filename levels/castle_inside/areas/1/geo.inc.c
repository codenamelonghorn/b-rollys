...
*/
//todo: add room switcherz like real mario
extern Gfx castle_inside_dl_init_stuff[];
extern Gfx castle_inside_dl_destroy_stuff[];
#include "src/game/envfx_snow.h"
const GeoLayout castle_inside_area_1_geo_bowser[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_bowser_room_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_inside_area_1_geo_bowserAndCastle[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_bowser_room_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_maincastle_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_wallpushaa_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, /*1045, -1168, 9*/-200, 20, 200, castle_inside_dl_transparent_objs_mesh),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, inside_castle_seg7_dl_07023DB0),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_inside_area_1_geo_ccm[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_ccm_room_mesh),
		GEO_ASM(  0, geo_painting_update),
		GEO_ASM(PAINTING_ID(0, 1), geo_painting_draw),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_inside_area_1_geo_wf[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_wf_room_mesh),
		GEO_ASM(  0, geo_painting_update),
		GEO_ASM(PAINTING_ID(1, 1), geo_painting_draw),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_inside_area_1_geo_lll[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_lll_room_mesh),
		GEO_ASM(  0, geo_painting_update),
		GEO_ASM(PAINTING_ID(2, 1), geo_painting_draw),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_inside_area_1_geo_ddd[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_ddd_room_mesh),
		GEO_ASM(  0, geo_painting_update),
		GEO_ASM(PAINTING_ID(3, 1), geo_painting_draw),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_inside_area_1_geo_castle[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_maincastle_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_wallpushaa_mesh),
...
const GeoLayout castle_inside_area_1_geo_courtyard[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_maincastle_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_courtyard_room_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
...
const GeoLayout castle_inside_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_lll_room_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_maincastle_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_paintingWarps_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, /*1045, -1168, 9*/-200, 20, 200, castle_inside_dl_transparent_objs_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_wallpushaa_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE,      /*1045, -1168, 9*/-200, 0, 200, castle_inside_dl_wf_room_mesh),
	GEO_CLOSE_NODE(),
...
const GeoLayout castle_inside_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			GEO_CAMERA_FRUSTUM_WITH_FUNC(46.000, 100, 12800, geo_camera_fov),
			GEO_OPEN_NODE(),
				GEO_CAMERA(13, 0, 2000, 6000, 0, 0, 0, geo_camera_main),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_init_stuff),
					GEO_SWITCH_CASE(7, geo_switch_area),
					GEO_OPEN_NODE(),
						GEO_BRANCH(1, castle_inside_area_1_geo_castle),
						GEO_BRANCH(1, castle_inside_area_1_geo_ccm),
						GEO_BRANCH(1, castle_inside_area_1_geo_wf),
						GEO_BRANCH(1, castle_inside_area_1_geo_lll),
						GEO_BRANCH(1, castle_inside_area_1_geo_ddd),
						GEO_BRANCH(1, castle_inside_area_1_geo_courtyard),
						GEO_BRANCH(1, castle_inside_area_1_geo_bowserAndCastle),
					GEO_CLOSE_NODE(),
					GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_destroy_stuff),
					GEO_RENDER_OBJ(),
