...
//    OBJECT(/*model*/ MODEL_LEVEL_GEOMETRY_07, /*pos*/  1757, 3519, -3151, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
    // not actually breakable wall, just can't be bothered to find a new slot that will definitely stay empty
    OBJECT(/*model*/ MODEL_WF_BREAKABLE_WALL_RIGHT, /*pos*/  -60,  3519,  -2800, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvStaticObject),
...
static const LevelScript script_func_local_2[] = {
    ...
    OBJECT(/*model*/ MODEL_WF_SLIDING_PLATFORM,         /*pos*/  3328, 1075, -1798, /*angle*/ 0,  90, 0, /*behParam*/ 0x00020000, /*beh*/ bhvWfSlidingPlatform),
    OBJECT(/*model*/ MODEL_WF_SLIDING_PLATFORM,         /*pos*/  3328, 1075,  -772, /*angle*/ 0,  90, 0, /*behParam*/ 0x00010000, /*beh*/ bhvWfSlidingPlatform),
    OBJECT(/*model*/ MODEL_WF_SLIDING_PLATFORM,         /*pos*/  3328, 1075, -2818, /*angle*/ 0,  90, 0, /*behParam*/ 0x00030000, /*beh*/ bhvWfSlidingPlatform),
...
static const LevelScript script_func_local_3[] = {
    OBJECT(/*model*/ MODEL_WF_BUBBLY_TREE,     /*pos*/ 2560, 255,  4608, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvTree),
    OBJECT(/*model*/ MODEL_THWOMP,            /*pos*/  3535, 1939, -1558, /*angle*/ 0,  90, 0, /*behParam*/ 0x00000000, /*beh*/ bhvThwomp),
    OBJECT(/*model*/ MODEL_THWOMP,            /*pos*/  3462, 1075, -3314, /*angle*/ 0,  180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvThwomp2),
    ...
    OBJECT(/*model*/ MODEL_WF_GIANT_POLE,              /*pos*/  1035, 2560,  -900, /*angle*/ 0,   45, 0, /*behParam*/ 0x00000000, /*beh*/ bhvGiantPole),
    OBJECT(/*model*/ MODEL_NONE,              /*pos*/  1035, 2560,  -900, /*angle*/ 0,   45, 0, /*behParam*/ 0x00000000, /*beh*/ bhvPoleGrabbing),
    OBJECT(/*model*/ MODEL_WF_GIANT_POLE,              /*pos*/  -1345, 2560,  2404, /*angle*/ 0,   45, 0, /*behParam*/ 0x00000000, /*beh*/ bhvGiantPole),
    OBJECT(/*model*/ MODEL_NONE,              /*pos*/  -1345, 2560,  2404, /*angle*/ 0,   45, 0, /*behParam*/ 0x00000000, /*beh*/ bhvPoleGrabbing),
...
static const LevelScript script_func_local_4[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/   300, 5550,     0, /*angle*/ 0, 0, 0, /*behParam*/ 0x01000000, /*beh*/ bhvStar,                 /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/  0000, 3750, -2800, /*angle*/ 0, 0, 0, /*behParam*/ 0x02000000, /*beh*/ bhvStar,                 /*acts*/ ALL_ACTS),
...
extern Gfx geo_mountain_floating_platform[];
...
const LevelScript level_wf_entry[] = {
    ...
    LOAD_MIO0_TEXTURE(/*seg*/ 0x09, _grass_beta_mio0SegmentRomStart, _grass_beta_mio0SegmentRomEnd),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_WF_BREAKABLE_WALL_RIGHT,          geo_mountain_floating_platform),
    ...
    AREA(/*index*/ 1, wf_area_1),
        ...
        TERRAIN(/*terrainData*/ wf_area_1_collision),
