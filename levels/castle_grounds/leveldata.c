...
#define SCALE 0.25
#define ShapeColor_mainmap2(R,G,B) gdSPDefLights1(R*SCALE, G*SCALE, B*SCALE, R, G, B, LIGHT_X, LIGHT_Y, LIGHT_Z)

static Lights1 light_mainmap2[] = {
	ShapeColor_mainmap2(255,255,255),
	ShapeColor_mainmap2(48,224,0),
	ShapeColor_mainmap2(0,0,0),
	ShapeColor_mainmap2(120, 120, 144),
};
...
#include "levels/castle_grounds/areamap/areamap.inc.c"
