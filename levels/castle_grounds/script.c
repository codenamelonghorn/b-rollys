...
static const LevelScript script_func_local_4[] = {
 ...
 //BJECT(/*model*/ MODEL_BUTTERFLY, /*pos*/  6543,  461,  -617, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvButterfly),
...
const LevelScript level_castle_grounds_entry[] = {
    ...
    //LOAD_MODEL_FROM_GEO(MODEL_CASTLE_GROUNDS_METAL_DOOR,   castle_door_geo),
